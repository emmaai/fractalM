...
QT_MOC_LITERAL(3, 26, 7)
    ...
    "colorLabel\0colorSelected\0\0QColor*\0"
};
...
void colorLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (colorLabel::*_t)(QColor * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&colorLabel::colorSelected)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void colorLabel::colorSelected(QColor * _t1)
{
