...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_graphView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 44, 11)
    ...
    "graphView\0shuffle\0\0zoomIn\0zoomOut\0"
    "scaleView\0scaleFactor\0"
};
...
void graphView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->scaleView((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject graphView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_graphView.data,
      qt_meta_data_graphView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_graphView.stringdata))
