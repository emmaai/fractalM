...
IF (WIN32)
    ...
    ELSEIF(VRN_MINGW)
	    ...
	    SET(GLEW_LIBRARY_DEBUG      "${GLEW_DIR}/lib/libglew32.dll.a")
            SET(GLEW_DLL_DEBUG          "${GLEW_DIR}/lib/glew32.dll")
            SET(GLEW_LIBRARY_RELEASE    "${GLEW_DIR}/lib/libglew32.dll.a")
            SET(GLEW_DLL_RELEASE        "${GLEW_DIR}/lib/glew32.dll")
    ENDIF()
